...
Living status / backlog (only): [`docs/backlog/current.md`](../backlog/current.md). **当前线 v0.3.1**（harness R1–R5 + Tab Auto + 产品 README）。Phase Q + Q-harden = v0.2.8。下一优先：O5–O6 / H2 / M*（等用户再提）。  
