...
Core migration runner 统一拥有 schema 版本。Migration 013 删除旧 Module Registry、消费位点和 Evolution Activation 遗留表；015–027 为后续追加。历史 migration 序号保留，避免破坏已经存在的 `core.db` 升级路径。
